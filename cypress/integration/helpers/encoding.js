/*
getShortType = type => TYPES_SHORT[TYPES_LONG.indexOf(type)] || 'U'
getLongType = type =>
getShortRarity = rarity =>
getLongRarity = rarity =>
getShortRace = race => RACES_SHORT[RACES_LONG.indexOf(race)] || ''
getLongRace = race => RACES_LONG[RACES_SHORT.indexOf(race)] || ''
getShortCurrency = currency =>
getLongCurrency = currency =>
*/
import {
  getShortFaction,
  getLongFaction,
