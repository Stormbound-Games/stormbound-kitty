...
const CardBuilderImageErrorDialog = React.memo(
  function CardBuilderImageErrorDialog(props) {
    ...
    return (
      ...
      >
        {isImgurPage ? (
          <p>
            It looks like you copied the link of the Imgur page instead of the
            URL of the image itself. On Imgur, right click or long tap on the
            image and select “Copy image address”. The image should be served
            from i.imgur.com.
          </p>
        ) : (
          <>
