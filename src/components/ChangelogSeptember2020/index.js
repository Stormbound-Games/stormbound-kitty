...
export default React.memo(function ChangelogSeptember2020(props) {
  return (
    ...
    >
      ...
      <p>
        <CardLink id='N38' /> now cost 5 mana (instead of 6). Hopefully a way to
      ...
      <p>
        <CardLink id='N51' /> now cost 6 mana (instead of 7) and has 4/5/6/8/10
      ...
      <p>
        <CardLink id='I5' /> now has 5/6/7/8/9 strength (instead of 4/5/6/7/8),
