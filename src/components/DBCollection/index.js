...
import ActiveCardForm from '../DBCollectionActiveCardForm'
import CollectionStats from '../DBCollectionStats'
import Filtering from '../DBFiltering'
import Filters from '../DBCollectionFilters'
...
class DBCollection extends React.Component {
  constructor(props) {
    super(props)
