...
const GuideDeck = props => (
  ...
  >
    ...
    <ul>
      ...
      <li>
        Your first turn will be 3 or 4 mana depending on whether you play first,
        then 4/5 mana.
      </li>
      <li>
    ...
    <p>
      If you have more than 4 cards in your deck which cost 4 mana or greater on
      the first turn, you run a moderate chance of having one, or worse, two
      turns doing nothing.
    </p>
    ...
    <p>
      Consider what would be the earliest turn for you to play a full hand of 4
      cards. For some, it is a disgusting low 5 mana (
    ...
    <p>
      Usually (albeit not always), playing more cards is more advantageous than
      playing a big one.
    </p>
    ...
    <p>
      ...
      take up available space on the board. Advancing the front line gives more
      space to play more cards.
    </p>

    <p>
      Single movement units can clear up space, but they don’t share the front.
      Units which block the front, and help hold the front, are necessary.
      Structures <em>hold</em> the front, but won’t advance it; however they are
      immune to poisoning and freezing, as well as a number of attack effects
      and spells.
    </p>

    <p>
      Secondly, you need your game winner, as mentioned above. You must have at
      least one of these in your deck — you cannot expect to reliably stall out
      and casually pass some units through for the win. Not reliably at least.
    </p>
    ...
    <p>
      ...
      you in the game and are necessary. You need at least one, in some form. If
      they are cheap (3 or less) these are the cards you consider holding for a
      turn or two when cycling, in case you need them.
    </p>

    <p>
      Between these controls and the ability of immobile units to simply absorb
      the opponent’s big units, big units are the least reliable game winner.
    </p>

    <Title id='synergies'>Synergies</Title>

    <p>
      This is about how cards work together in combination. Try and find a few.
      Some will be obvious such as <WikiLink id='S1' /> & <WikiLink id='S9' />,{' '}
      <WikiLink id='I2' /> & <WikiLink id='I19' />, <WikiLink id='F2' /> &{' '}
      <WikiLink id='F11' />, <WikiLink id='W2' /> & <WikiLink id='W4' />…
    </p>
    ...
    <p>
      ...
      <WikiLink id='I1' /> detonating a <WikiLink id='I12' /> to drive back the
      opponent’s front.
    </p>
    ...
    <p>
      ...
      <WikiLink id='S12' />, <WikiLink id='N38' />, and so on while also taking
      care of big units.
    </p>
    ...
    <ul>
      ...
      <li>you will have 3 or 4 mana on your first turn (4 or 5 on the next)</li>
      <li>
    ...
    <p>
      … there is a 1/12 chance that any card will be in your hand. But since you
      draw a third of the deck (4 out of 12) into your hand, from turn 1 you
      have a 1/3 chance that any given card is among the 4/12 that makes your
      starting hand. Since the game does not allow for multiples occurrences of
      the same card in a hand at one time — if you do not have the card you
      would like, then the likelihood of getting it when cycling is
      significantly greater.
    </p>

    <p>
      <strong>Your first turn gives you 3 or 4 mana</strong> (depending on who
      goes first). The number of cards you can play at 3 mana are any which cost
      3 or less.
    </p>
    ...
    <p>
      ...
      when you have 5 mana available, that is 2 turns into the game. Combos can
      and should be built and active by this point.
    </p>

    <p>
      You won’t be able to play two 3-mana cards together before you have 6
      mana. Anything costing more is still several turns away. Cycle them until
      the timing is perfect.
    </p>

    <p>
      These low-cast cards make up the core of your deck, as you will be able to
      play them every turn since the first.
    </p>

    <Title id='redundancies'>Redundancies</Title>

    <p>
      Are you running multiple cards which do the same thing? Do you really need{' '}
      <WikiLink id='N36' /> <em>and</em> <WikiLink id='F14' />?{' '}
    ...
    <p>
      ...
      <WikiLink id='N15' />, <WikiLink id='I11' />, <WikiLink id='N20' />, etc.)
      then focus on units over structures or spells (i.e. <WikiLink id='N11' />
    ...
    <p>
      ...
      <WikiLink id='I12' />) are not necessarily redundant; however if you have
      5 of them, your deck is probably too expensive. Try focusing on two or
      three that have synergy with other cards in your deck (2 movement cards
      need a close enough front to run from for instance).
    </p>
