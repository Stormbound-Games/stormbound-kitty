...
export default React.memo(function Cat(props) {
  return (
    <svg
      version='1.1'
    ...
    >
      <g>
        <path
          d='M111.1,5.103c-1.8,0-3.5,0.3-5.199,1l-19.601,7.9c-7.5-2.7-15.5-4.1-23.8-4.1c-8.2,0-16.2,1.4-23.8,4.1l-19.6-7.9
