...
export default React.memo(function PageBooksCalculator(props) {
    ...
    setExpectations(expectations => [
      ...
      value === ''
        ...
        : clamp(
            0,
            Number(value),
            countCards(cardsWithoutTokens, { rarity: RARITIES[index] }, true),
          ),
                ...
                <Row withNarrowGutter>
                  <Row.Column>
                    <NumberInput
                      label='Common cards'
                      min={0}
                      max={countCards(cardsWithoutTokens, { rarity: 'common' })}
                      name='target-common'
                      id='target-common'
                  ...
                  <Row.Column>
                    <NumberInput
                      label='Rare cards'
                      min={0}
                      max={countCards(cardsWithoutTokens, { rarity: 'rare' })}
                      name='target-rare'
                      id='target-rare'
                ...
                <Row withNarrowGutter>
                  <Row.Column>
                    <NumberInput
                      label='Epic cards'
                      min={0}
                      max={countCards(cardsWithoutTokens, { rarity: 'epic' })}
                      name='target-epic'
                      id='target-epic'
                  ...
                  <Row.Column>
                    <NumberInput
                      ...
                      min={0}
                      max={countCards(cardsWithoutTokens, {
                        rarity: 'legendary',
                      })}
