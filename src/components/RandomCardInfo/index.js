    ...
    async filters => {
      ...
      try {
        ...
        setCardData(cardData => ({
          ...
          mana: card.mana ?? INITIAL_STATE.mana,
          strength:
    ...
    <>
      ...
      >
        <p style={{ marginBottom: hasErrored ? 'var(--s-base)' : '0' }}>
          ...
          should generate a relatively balanced card for you to get started!
          From there, you can tweak it to suit your needs.
        </p>
      ...
      <RandomCardFilters dialog={dialog} createRandomCard={createRandomCard} />
    </>
  )
})
