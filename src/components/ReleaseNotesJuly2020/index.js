      ...
      <Article.Narrow>
        ...
        <Info icon='heart' title='Nerf compensation'>
          <p>
            ...
            stones will be provided to owners of these nerfed cards,
            proportional to the level and rarity of the card. Find below the
            reimbursement values for each rarity and level (coins/stones).
          </p>
