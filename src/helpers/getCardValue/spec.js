...
describe('The `getCardValue` helper', () => {
  ...
  it('should return value for Potion of Growth', () => {
    ...
    expect(value1[1]).toEqual(3 / 3)
    expect(value5[0]).toEqual(7 / 3)
    expect(value5[1]).toEqual(7 / 3)
  })
  ...
  it('should return value for Execution', () => {
    ...
    expect(value1[1]).toEqual(5 / 4)
    expect(value5[0]).toEqual(1 / 4)
    expect(value5[1]).toEqual(9 / 4)
  })
  ...
  it('should return value for Lich Summoners', () => {
    ...
    expect(value1[0]).toEqual((4 / 4) * 1)
    expect(value1[1]).toEqual(((4 + 3) / 4) * 1)
    expect(value5[0]).toEqual((7 / 4) * 1)
  ...
  it('should return value for Frontline Engineers', () => {
    ...
    expect(value1[0]).toEqual((3 / 4) * 1)
    expect(value1[1]).toEqual(((3 + 2 * 8) / 4) * 1)
    expect(value5[0]).toEqual((6 / 4) * 1)
    expect(value5[1]).toEqual(((6 + 4 * 8) / 4) * 1)
  })
  ...
  it('should return value for Amberhides', () => {
    ...
    expect(value1[0]).toEqual((5 / 5) * 1)
    expect(value1[1]).toEqual(((5 + 4 * 2) / 5) * 1)
    expect(value5[0]).toEqual((9 / 5) * 1)
    expect(value5[1]).toEqual(((9 + 8 * 2) / 5) * 1)
  })
  ...
  it('should return value for Hairy Chestnuts', () => {
    ...
    expect(value1[0]).toEqual((6 / 6) * 0.5)
    expect(value1[1]).toEqual(((6 + 2 * 1) / 6) * 0.5)
    expect(value5[0]).toEqual((14 / 6) * 0.5)
    expect(value5[1]).toEqual(((14 + 2 * 2) / 6) * 0.5)
  })
  ...
  it('should return value for Mischiefs', () => {
    ...
    expect(value1[0]).toEqual(((3 + 1) / 4) * 1)
    expect(value1[1]).toEqual(((3 + 1) / 4) * 1)
    expect(value5[0]).toEqual(((7 + 2) / 4) * 1)
    expect(value5[1]).toEqual(((7 + 2) / 4) * 1)
  })
  ...
  it('should return value for Xuri, Lord of Life', () => {
    ...
    expect(value1[0]).toEqual((3 / 5) * 0.5)
    expect(value1[1]).toEqual(((3 + 3 * 1) / 5) * 2)
    expect(value5[0]).toEqual((7 / 5) * 0.5)
    expect(value5[1]).toEqual(((7 + 3 * 5) / 5) * 2)
  })
  ...
  it('should return value for Icicle Burst', () => {
    ...
    expect(value1[1]).toEqual(6 / 1)
    expect(value5[0]).toEqual(1 / 1)
    expect(value5[1]).toEqual(12 / 1)
  })
  ...
  it('should return value for Earthfathers', () => {
    ...
    expect(value1[0]).toEqual((6 / 7) * 1)
    expect(value1[1]).toEqual(((6 + 4) / 7) * 1)
    expect(value5[0]).toEqual((12 / 7) * 1)
    expect(value5[1]).toEqual(((12 + 5) / 7) * 1)
  })
