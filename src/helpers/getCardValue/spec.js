...
describe('The `getCardValue` helper', () => {
  it('should return value for Green Prototypes', () => {
    ...
    expect(value1[1]).to.equal((1 / 1) * 1)
    expect(value5[0]).to.equal(0)
    expect(value5[1]).to.equal((5 / 1) * 1)
  })

  it('should return value for Summon Militia', () => {
    const value1 = getCardValue('N2', 1)
    const value5 = getCardValue('N2', 5)
    expect(value1[0]).to.equal((1 / 1) * 0.5)
    expect(value1[1]).to.equal((1 / 1) * 0.5)
    expect(value5[0]).to.equal((5 / 1) * 0.5)
    expect(value5[1]).to.equal((5 / 1) * 0.5)
  })

  it('should return value for Gifted Recruits', () => {
    const value1 = getCardValue('N3', 1)
    const value5 = getCardValue('N3', 5)
    expect(value1[0]).to.equal((1 / 2) * 1)
    expect(value1[1]).to.equal((1 / 2) * 1)
    expect(value5[0]).to.equal((5 / 2) * 1)
    expect(value5[1]).to.equal((5 / 2) * 1)
  })

  it('should return value for Lawless Herd', () => {
    const value1 = getCardValue('N4', 1)
    const value5 = getCardValue('N4', 5)
    expect(value1[0]).to.equal((2 / 2) * 0.5)
    expect(value1[1]).to.equal((2 / 2) * 0.5)
    expect(value5[0]).to.equal((6 / 2) * 0.5)
    expect(value5[1]).to.equal((6 / 2) * 0.5)
  })

  it('should return value for Northsea Dog', () => {
    const value1 = getCardValue('N5', 1)
    const value5 = getCardValue('N5', 5)
    expect(value1[0]).to.equal((1 / 2) * 0.5)
    expect(value1[1]).to.equal(((1 + 5) / 2) * 0.5)
    expect(value5[0]).to.equal((1 / 2) * 0.5)
    expect(value5[1]).to.equal(((1 + 10) / 2) * 0.5)
  })
  ...
  it('should return value for Spare Dragonling', () => {
    ...
    expect(value1[0]).to.equal((1 / 2) * 1)
    expect(value1[1]).to.equal(((1 + 3) / 2) * 1)
    expect(value5[0]).to.equal((1 / 2) * 1)
    expect(value5[1]).to.equal(((1 + 7) / 2) * 1)
  })
  ...
  it('should return value for Brothers in Arms', () => {
    ...
    expect(value1[1]).to.equal(((3 + 1) / 3) * 0.5)
    expect(value5[0]).to.equal((6 / 3) * 0.5)
    expect(value5[1]).to.equal(((6 + 3) / 3) * 0.5)
  })
  ...
  it('should return value for Confinement', () => {
    ...
    expect(value1[0]).to.equal(1 / 3)
    expect(value1[1]).to.equal((10 - 5) / 3)
    expect(value5[0]).to.equal(1 / 3)
    expect(value5[1]).to.equal((24 - 1) / 3)
  })

  it('should return value for Conflicted Drakes', () => {
    const value1 = getCardValue('N10', 1)
    const value5 = getCardValue('N10', 5)
    expect(value1[0]).to.equal((2 / 3) * 0.5)
    expect(value1[1]).to.equal(((2 + 1 * 4) / 3) * 0.5)
    expect(value5[0]).to.equal((4 / 3) * 0.5)
    expect(value5[1]).to.equal(((4 + 3 * 4) / 3) * 0.5)
  })
  ...
  it('should return value for Felflares', () => {
    ...
    expect(value1[0]).to.equal((2 / 3) * 0.5)
    expect(value1[1]).to.equal(((2 + 2) / 3) * 0.5)
    expect(value5[0]).to.equal((2 / 3) * 0.5)
    expect(value5[1]).to.equal(((2 + 6) / 3) * 0.5)
  })

  it('should return value for First Mutineer', () => {
    const value1 = getCardValue('N12', 1)
    const value5 = getCardValue('N12', 5)
    expect(value1[0]).to.equal((1 / 3) * 1.5)
    expect(value1[1]).to.equal((1 / 3) * 1.5)
    expect(value5[0]).to.equal((5 / 3) * 1.5)
    expect(value5[1]).to.equal((5 / 3) * 1.5)
  })

  it('should return value for Fort of Ebonrock', () => {
    const value1 = getCardValue('N13', 1)
    const value5 = getCardValue('N13', 5)
    expect(value1[0]).to.equal(4 / 3)
    expect(value1[1]).to.equal(4 / 3)
    expect(value5[0]).to.equal(8 / 3)
    expect(value5[1]).to.equal(8 / 3)
  })
  ...
  it('should return value for Freebooters', () => {
    ...
    expect(value1[0]).to.equal((2 / 3) * 0.5)
    expect(value1[1]).to.equal((2 / 3) * 0.5)
    expect(value5[0]).to.equal((5 / 3) * 0.5)
    expect(value5[1]).to.equal((5 / 3) * 0.5)
  })
  ...
  it('should return value for Wetland Deceivers', () => {
    ...
    expect(value1[0]).to.equal(((3 - 8 * 1) / 3) * 0.5)
    expect(value1[1]).to.equal(((3 + 8 * 1) / 3) * 0.5)
    expect(value5[0]).to.equal(((6 - 8 * 3) / 3) * 0.5)
    expect(value5[1]).to.equal(((6 + 8 * 3) / 3) * 0.5)
  })
  ...
  it('should return value for Cabin Girls', () => {
    ...
    expect(value1[0]).to.equal((5 / 4) * 0.5)
    expect(value1[1]).to.equal((5 / 4) * 0.5)
    expect(value5[0]).to.equal((10 / 4) * 0.5)
    expect(value5[1]).to.equal((10 / 4) * 0.5)
  })
  ...
  it('should return value for Emerald Towers', () => {
    ...
    expect(value1[1]).to.equal((4 + 2 * 4) / 4)
    expect(value5[0]).to.equal(8 / 4)
    expect(value5[1]).to.equal((8 + 4 * 4) / 4)
  })
  ...
  it('should return value for Goldgrubbers', () => {
    ...
    expect(value1[1]).to.equal((4 / 4) * 1)
    expect(value5[0]).to.equal((8 / 4) * 1)
    expect(value5[1]).to.equal((8 / 4) * 1)
  })
  ...
  it('should return value for Siegebreakers', () => {
    ...
    expect(value1[0]).to.equal((4 / 4) * 1)
    expect(value1[1]).to.equal(((4 + 4 * 8) / 4) * 1)
    expect(value5[0]).to.equal((8 / 4) * 1)
    expect(value5[1]).to.equal(((8 + 8 * 8) / 4) * 1)
  })
  ...
  it('should return value for Snowmasons', () => {
    ...
    expect(value1[1]).to.equal(((2 + 4) / 4) * 1)
    expect(value5[0]).to.equal((2 / 4) * 1)
    expect(value5[1]).to.equal(((2 + 8) / 4) * 1)
  })

  it('should return value for Terrific Slayers', () => {
    const value1 = getCardValue('N27', 1)
    const value5 = getCardValue('N27', 5)
    expect(value1[0]).to.equal((2 / 4) * 1.5)
    expect(value1[1]).to.equal(((2 + 5 * 2) / 4) * 1.5)
    expect(value5[0]).to.equal((6 / 4) * 1.5)
    expect(value5[1]).to.equal(((6 + 10 * 2) / 4) * 1.5)
  })
  ...
  it('should return value for Warfront Runners', () => {
    ...
    expect(value1[0]).to.equal((2 / 4) * 1.5)
    expect(value1[1]).to.equal((2 / 4) * 1.5)
    expect(value5[0]).to.equal((6 / 4) * 1.5)
    expect(value5[1]).to.equal((6 / 4) * 1.5)
  })

  it('should return value for Bladestorm', () => {
    const value1 = getCardValue('N29', 1)
    const value5 = getCardValue('N29', 5)
    expect(value1[0]).to.equal(1 / 5)
    expect(value1[1]).to.equal((1 * 20) / 5)
    expect(value5[0]).to.equal(4 / 5)
    expect(value5[1]).to.equal((4 * 20) / 5)
  })
  ...
  it('should return value for Flooding the Gates', () => {
    ...
    expect(value1[0]).to.equal((5 * 4) / -4)
    expect(value1[1]).to.equal((5 * 4) / 4)
    expect(value5[0]).to.equal((10 * 4) / -4)
    expect(value5[1]).to.equal((10 * 4) / 4)
  })

  it('should return value for Heroic Soldiers', () => {
    const value1 = getCardValue('N32', 1)
    const value5 = getCardValue('N32', 5)
    expect(value1[0]).to.equal((5 / 5) * 1)
    expect(value1[1]).to.equal((5 / 5) * 1)
    expect(value5[0]).to.equal((10 / 5) * 1)
    expect(value5[1]).to.equal((10 / 5) * 1)
  })

  it('should return value for Snake Eyes', () => {
    const value1 = getCardValue('N33', 1)
    const value5 = getCardValue('N33', 5)
    expect(value1[0]).to.equal((6 / 5) * 0.5)
    expect(value1[1]).to.equal((6 / 5) * 0.5)
    expect(value5[0]).to.equal((12 / 5) * 0.5)
    expect(value5[1]).to.equal((12 / 5) * 0.5)
  })

  it('should return value for Trueshot Post', () => {
    const value1 = getCardValue('N34', 1)
    const value5 = getCardValue('N34', 5)
    expect(value1[0]).to.equal(4 / 5)
    expect(value1[1]).to.equal((4 + 4) / 5)
    expect(value5[0]).to.equal(8 / 5)
    expect(value5[1]).to.equal((8 + 8) / 5)
  })
  ...
  it('should return value for Voidsurgers', () => {
    ...
    expect(value1[0]).to.equal((6 / 5) * 0.5)
    expect(value1[1]).to.equal(((6 + 2 * 8) / 5) * 0.5)
    expect(value5[0]).to.equal((6 / 5) * 0.5)
    expect(value5[1]).to.equal(((6 + 6 * 8) / 5) * 0.5)
  })
  ...
  it('should return value for Boomstick Officers', () => {
    ...
    expect(value1[1]).to.equal(((5 + 3) / 6) * 1)
    expect(value5[0]).to.equal((10 / 6) * 1)
    expect(value5[1]).to.equal(((10 + 7) / 6) * 1)
  })
  ...
  it('should return value for Hearthguards', () => {
    ...
    expect(value1[0]).to.equal((3 / 6) * 1.5)
    expect(value1[1]).to.equal(((3 + 3) / 6) * 1.5)
    expect(value5[0]).to.equal((7 / 6) * 1.5)
    expect(value5[1]).to.equal(((7 + 7) / 6) * 1.5)
  })
  ...
  it('should return value for Lich Summoners', () => {
    ...
    expect(value1[0]).to.equal((3 / 4) * 1)
    expect(value1[1]).to.equal(((3 + 3) / 4) * 1)
    expect(value5[0]).to.equal((6 / 4) * 1)
    expect(value5[1]).to.equal(((6 + 6) / 4) * 1)
  })

  it('should return value for Lucky Charmers', () => {
    const value1 = getCardValue('N42', 1)
    const value5 = getCardValue('N42', 5)
    expect(value1[0]).to.equal((3 / 6) * 1)
    expect(value1[1]).to.equal(((3 + 3 * 3) / 6) * 1)
    expect(value5[0]).to.equal((6 / 6) * 1)
    expect(value5[1]).to.equal(((6 + 6 * 3) / 6) * 1)
  })
  ...
  it('should return value for Ludic Matriarchs', () => {
    ...
    expect(value1[1]).to.equal(((5 + 1 * 6) / 6) * 0.5)
    expect(value5[0]).to.equal((10 / 6) * 0.5)
    expect(value5[1]).to.equal(((10 + 3 * 6) / 6) * 0.5)
  })

  it('should return value for Needle Blast', () => {
    const value1 = getCardValue('N44', 1)
    const value5 = getCardValue('N44', 5)
    expect(value1[0]).to.equal((2 * 1) / 6)
    expect(value1[1]).to.equal((2 * 2) / 6)
    expect(value5[0]).to.equal((4 * 1) / 6)
    expect(value5[1]).to.equal((4 * 4) / 6)
  })
  ...
  it('should return value for Tegor the Vengeful', () => {
    ...
    expect(value1[0]).to.equal(((4 + effect1) / 6) * 1.5)
    expect(value1[1]).to.equal(((4 + effect1) / 6) * 1.5)
    expect(value5[0]).to.equal(((8 + effect5) / 6) * 1.5)
    expect(value5[1]).to.equal(((8 + effect5) / 6) * 1.5)
  })
  ...
  it('should return value for Victors of the Melee', () => {
    ...
    expect(value1[0]).to.equal((3 / 6) * 1)
    expect(value1[1]).to.equal(((3 + 2 * 8) / 6) * 1)
    expect(value5[0]).to.equal((7 / 6) * 1)
    expect(value5[1]).to.equal(((7 + 4 * 8) / 6) * 1)
  })
  ...
  it('should return value for Avian Stalkers', () => {
    ...
    expect(value1[0]).to.equal((5 / 6) * 0.5)
    expect(value1[1]).to.equal(((5 + 4 * 3) / 6) * 0.5)
    expect(value5[0]).to.equal((10 / 6) * 0.5)
    expect(value5[1]).to.equal(((10 + 4 * 7) / 6) * 0.5)
  })

  it('should return value for Call for Aid', () => {
    const value1 = getCardValue('N50', 1)
    const value5 = getCardValue('N50', 5)
    expect(value1[0]).to.equal(3 / 7)
    expect(value1[1]).to.equal((3 * 4) / 7)
    expect(value5[0]).to.equal(7 / 7)
    expect(value5[1]).to.equal((7 * 4) / 7)
  })
  ...
  it('should return value for Salty Outcasts', () => {
    ...
    expect(value1[0]).to.equal((5 / 7) * 1.5)
    expect(value1[1]).to.equal((5 / 7) * 1.5)
    expect(value5[0]).to.equal((10 / 7) * 1.5)
    expect(value5[1]).to.equal((10 / 7) * 1.5)
  })
  ...
  it('should return value for Veterans of War', () => {
    ...
    expect(value1[1]).to.equal((8 / 7) * 1)
    expect(value5[0]).to.equal((18 / 7) * 1)
    expect(value5[1]).to.equal((18 / 7) * 1)
  })
  ...
  it('should return value for Temple Guardians', () => {
    ...
    expect(value1[0]).to.equal((6 / 8) * 0.5)
    expect(value1[1]).to.equal(((6 + 4 * 3) / 8) * 0.5)
    expect(value5[0]).to.equal((12 / 8) * 0.5)
    expect(value5[1]).to.equal(((12 + 8 * 3) / 8) * 0.5)
  })

  it('should return value for Crazy Bombers', () => {
    const value1 = getCardValue('N57', 1)
    const value5 = getCardValue('N57', 5)
    expect(value1[0]).to.equal((6 / 8) * 1)
    expect(value1[1]).to.equal(((6 + 7) / 8) * 1)
    expect(value5[0]).to.equal((13 / 8) * 1)
    expect(value5[1]).to.equal(((13 + 15) / 8) * 1)
  })

  it('should return value for Siren of the Seas', () => {
    const value1 = getCardValue('N58', 1)
    const value5 = getCardValue('N58', 5)
    expect(value1[0]).to.equal((6 / 9) * 1.75)
    expect(value1[1]).to.equal(((6 + (10 - 3) * 3) / 9) * 1.75)
    expect(value5[0]).to.equal((12 / 9) * 1.75)
    expect(value5[1]).to.equal(((12 + (24 - 3) * 3) / 9) * 1.75)
  })

  it('should return value for Edrik the Fierce', () => {
    const value1 = getCardValue('N59', 1)
    const value5 = getCardValue('N59', 5)
    expect(value1[0]).to.equal((3 / 4) * 0.5)
    expect(value1[1]).to.equal(((3 + 3 * 5) / 4) * 0.5)
    expect(value5[0]).to.equal((7 / 4) * 0.5)
    expect(value5[1]).to.equal(((7 + 7 * 5) / 4) * 0.5)
  })

  it('should return value for Fluffy Badboxers', () => {
    const value1 = getCardValue('N60', 1)
    const value5 = getCardValue('N60', 5)
    expect(value1[0]).to.equal((6 / 5) * 1)
    expect(value1[1]).to.equal((6 / 5) * 1)
    expect(value5[0]).to.equal((12 / 5) * 1)
    expect(value5[1]).to.equal((12 / 5) * 1)
  })
  ...
  it('should return value for Hair-Raising Cats', () => {
    ...
    expect(value1[0]).to.equal((3 / 3) * 0.5)
    expect(value1[1]).to.equal(((3 + 10 * 2) / 3) * 0.5)
    expect(value5[0]).to.equal((7 / 3) * 0.5)
    expect(value5[1]).to.equal(((7 + 24 * 2) / 3) * 0.5)
  })
  ...
  it('should return value for Sweetcap Kittens', () => {
    ...
    expect(value1[0]).to.equal((1 / 2) * 0.5)
    expect(value1[1]).to.equal((1 / 2) * 0.5)
    expect(value5[0]).to.equal((5 / 2) * 0.5)
    expect(value5[1]).to.equal((5 / 2) * 0.5)
  })
  ...
  it('should return value for Melodious Sisters', () => {
    ...
    expect(value1[0]).to.equal((4 / 4) * 1)
    expect(value1[1]).to.equal(((4 + 4) / 4) * 1)
    expect(value5[0]).to.equal((8 / 4) * 1)
    expect(value5[1]).to.equal(((8 + 8) / 4) * 1)
  })
  ...
  it('should return value for Razor-Sharp Lynxes', () => {
    ...
    expect(value1[0]).to.equal((2 / 4) * 1)
    expect(value1[1]).to.equal((2.5 / 4) * 1.25)
    expect(value5[0]).to.equal((6 / 4) * 1)
    expect(value5[1]).to.equal((6.5 / 4) * 1.25)
  })
  ...
  it('should return value for Bigthrust Tigers', () => {
    ...
    expect(value1[0]).to.equal((1 / 2) * 0.5)
    expect(value1[1]).to.equal((1 / 2) * 2)
    expect(value5[0]).to.equal((5 / 2) * 0.5)
    expect(value5[1]).to.equal((5 / 2) * 2)
  })
  ...
  it('should return value for Wild Saberpaws', () => {
    ...
    expect(value1[0]).to.equal((1 / 2) * 0.5)
    expect(value1[1]).to.equal((1 / 2) * 1.5)
    expect(value5[0]).to.equal((5 / 2) * 0.5)
    expect(value5[1]).to.equal((5 / 2) * 1.5)
  })
  ...
  it('should return value for Twilight Prowlers', () => {
    ...
    expect(value1[1]).to.equal((7 / 6) * 1.75)
    expect(value5[0]).to.equal((15 / 6) * 0.5)
    expect(value5[1]).to.equal((15 / 6) * 1.75)
  })
  ...
  it('should return value for Laurus, King in Exile', () => {
    ...
    expect(value1[0]).to.equal((5 / 5) * 1)
    expect(value1[1]).to.equal(((5 + 4 * 3 * 2) / 5) * 1)
    expect(value5[0]).to.equal((10 / 5) * 1)
    expect(value5[1]).to.equal(((10 + 8 * 3 * 2) / 5) * 1)
  })

  it('should return value for Aged Duskbringers', () => {
    const value1 = getCardValue('N70', 1)
    const value5 = getCardValue('N70', 5)
    expect(value1[0]).to.equal((4 / 7) * 1)
    expect(value1[1]).to.equal(((4 + 4) / 7) * 1)
    expect(value5[0]).to.equal((9 / 7) * 1)
    expect(value5[1]).to.equal(((9 + 9) / 7) * 1)
  })

  it('should return value for Rapid Mousers', () => {
    const value1 = getCardValue('N71', 1)
    const value5 = getCardValue('N71', 5)
    expect(value1[0]).to.equal((1 / 4) * 1.75)
    expect(value1[1]).to.equal((1 / 4) * 1.75)
    expect(value5[0]).to.equal((5 / 4) * 1.75)
    expect(value5[1]).to.equal((5 / 4) * 1.75)
  })

  it('should return value for Seasick Bouncers', () => {
    const value1 = getCardValue('N72', 1)
    const value5 = getCardValue('N72', 5)
    expect(value1[0]).to.equal((8 / 6) * 0.5)
    expect(value1[1]).to.equal((8 / 6) * 0.5)
    expect(value5[0]).to.equal((18 / 6) * 0.5)
    expect(value5[1]).to.equal((18 / 6) * 0.5)
  })
  ...
  it('should return value for Beards of Crowglyph', () => {
    ...
    expect(value1[1]).to.equal(((6 + 6 - 1) / 6) * 0.5)
    expect(value5[0]).to.equal((12 / 6) * 0.5)
    expect(value5[1]).to.equal(((12 + 12 - 1) / 6) * 0.5)
  })
  ...
  it('should return value for Destructobots', () => {
    ...
    expect(value1[0]).to.equal(((2 - 1) / 2) * 1)
    expect(value1[1]).to.equal((2 / 2) * 1)
    expect(value5[0]).to.equal(((6 - 1) / 2) * 1)
    expect(value5[1]).to.equal((6 / 2) * 1)
  })
  ...
  it('should return value for Unstable Build', () => {
    ...
    expect(value1[0]).to.equal(5 / 2)
    expect(value1[1]).to.equal(5 / 2)
    expect(value5[0]).to.equal(9 / 2)
    expect(value5[1]).to.equal(9 / 2)
  })
  ...
  it('should return value for Finite Loopers', () => {
    ...
    expect(value1[0]).to.equal((3 / 4) * 1)
    expect(value1[1]).to.equal(((3 + 1) / 4) * 1)
    expect(value5[0]).to.equal((6 / 4) * 1)
    expect(value5[1]).to.equal(((6 + 3) / 4) * 1)
  })
  ...
  it('should return value for Greengale Serpents', () => {
    ...
    expect(value1[0]).to.equal((1 / 3) * 1.5)
    expect(value1[1]).to.equal(((1 + 1 * 2) / 3) * 1.5)
    expect(value5[0]).to.equal((3 / 3) * 1.5)
    expect(value5[1]).to.equal(((3 + 3 * 2) / 3) * 1.5)
  })
  ...
  it('should return value for Sound Drivers', () => {
    ...
    expect(value1[0]).to.equal((3 / 3) * 0.5)
    expect(value1[1]).to.equal((3 / 3) * 2)
    expect(value5[0]).to.equal((7 / 3) * 0.5)
    expect(value5[1]).to.equal((7 / 3) * 2)
  })
  ...
  it('should return value for Upgrade Point', () => {
    ...
    expect(value1[0]).to.equal(4 / 3)
    expect(value1[1]).to.equal((4 + 2 * 8) / 3)
    expect(value5[0]).to.equal(8 / 3)
    expect(value5[1]).to.equal((8 + 5 * 8) / 3)
  })
  ...
  it('should return value for Boosting Elixir', () => {
    ...
    expect(value1[1]).to.equal((3 + 3) / 4)
    expect(value5[0]).to.equal(6 / 4)
    expect(value5[1]).to.equal((6 + 6) / 4)
  })

  it('should return value for Chaotic Pupil', () => {
    const value1 = getCardValue('I12', 1)
    const value5 = getCardValue('I12', 5)
    expect(value1[0]).to.equal((1 / 5) * 1.5)
    expect(value1[1]).to.equal(((1 + 3) / 5) * 1.5)
    expect(value5[0]).to.equal((1 / 5) * 1.5)
    expect(value5[1]).to.equal(((1 + 7) / 5) * 1.5)
  })

  it('should return value for Embers of Chaos', () => {
    const value1 = getCardValue('I13', 1)
    const value5 = getCardValue('I13', 5)
    expect(value1[0]).to.equal((1 / 4) * 1)
    expect(value1[1]).to.equal(((1 + 6) / 4) * 1)
    expect(value5[0]).to.equal((1 / 4) * 1)
    expect(value5[1]).to.equal(((1 + 12) / 4) * 1)
  })
  ...
  it('should return value for Mech Workshop', () => {
    ...
    expect(value1[0]).to.equal(3 / 4)
    expect(value1[1]).to.equal((3 + 2) / 4)
    expect(value5[0]).to.equal(6 / 4)
    expect(value5[1]).to.equal((6 + 6) / 4)
  })
  ...
  it('should return value for Overchargers', () => {
    ...
    expect(value1[0]).to.equal(((2 + 1) / 4) * 1)
    expect(value1[1]).to.equal(((2 + 1) / 4) * 1)
    expect(value5[0]).to.equal(((5 + 3) / 4) * 1)
    expect(value5[1]).to.equal(((5 + 3) / 4) * 1)
  })
  ...
  it('should return value for Debug Loggers', () => {
    ...
    expect(value1[1]).to.equal(((4 + 2 * 2) / 5) * 1)
    expect(value5[0]).to.equal((8 / 5) * 1)
    expect(value5[1]).to.equal(((8 + 5 * 2) / 5) * 1)
  })

  it('should return value for Eloth the Ignited', () => {
    const value1 = getCardValue('I17', 1)
    const value5 = getCardValue('I17', 5)
    expect(value1[0]).to.equal((5 / 5) * 2)
    expect(value1[1]).to.equal(((5 + 3) / 5) * 2)
    expect(value5[0]).to.equal((10 / 5) * 2)
    expect(value5[1]).to.equal(((10 + 7) / 5) * 2)
  })

  it('should return value for Flaming Stream', () => {
    const value1 = getCardValue('I18', 1)
    const value5 = getCardValue('I18', 5)
    expect(value1[0]).to.equal((3 * 1) / 5)
    expect(value1[1]).to.equal((3 * 5) / 5)
    expect(value5[0]).to.equal((7 * 1) / 5)
    expect(value5[1]).to.equal((7 * 5) / 5)
  })

  it('should return value for Siege Assembly', () => {
    const value1 = getCardValue('I19', 1)
    const value5 = getCardValue('I19', 5)
    expect(value1[0]).to.equal((3 + 3) / 5)
    expect(value1[1]).to.equal((3 + 3) / 5)
    expect(value5[0]).to.equal((6 + 6) / 5)
    expect(value5[1]).to.equal((6 + 6) / 5)
  })
  ...
  it('should return value for Windmakers', () => {
    ...
    expect(value1[0]).to.equal((2 / 4) * 1.5)
    expect(value1[1]).to.equal(((2 + 3 * 2) / 4) * 1.5)
    expect(value5[0]).to.equal((2 / 4) * 1.5)
    expect(value5[1]).to.equal(((2 + 7 * 2) / 4) * 1.5)
  })

  it('should return value for Delegators', () => {
    const value1 = getCardValue('I21', 1)
    const value5 = getCardValue('I21', 5)
    expect(value1[0]).to.equal((7 / 6) * 1)
    expect(value1[1]).to.equal((7 / 6) * 1)
    expect(value5[0]).to.equal((15 / 6) * 1)
    expect(value5[1]).to.equal((15 / 6) * 1)
  })
  ...
  it('should return value for Project PH03-NIX', () => {
    ...
    expect(value1[0]).to.equal((5 / 6) * 1)
    expect(value1[1]).to.equal(((5 * 2) / 6) * 1)
    expect(value5[0]).to.equal((10 / 6) * 1)
    expect(value5[1]).to.equal(((10 * 2) / 6) * 1)
  })

  it('should return value for Armed Schemers', () => {
    const value1 = getCardValue('I23', 1)
    const value5 = getCardValue('I23', 5)
    expect(value1[0]).to.equal((7 / 7) * 0.5)
    expect(value1[1]).to.equal(((7 + 3 * 3) / 7) * 0.5)
    expect(value5[0]).to.equal((15 / 7) * 0.5)
    expect(value5[1]).to.equal(((15 + 7 * 3) / 7) * 0.5)
  })

  it('should return value for Mechanical Workers', () => {
    const value1 = getCardValue('I24', 1)
    const value5 = getCardValue('I24', 5)
    expect(value1[0]).to.equal((4 / 6) * 1)
    expect(value1[1]).to.equal(((4 + 3 + 2) / 6) * 1)
    expect(value5[0]).to.equal((8 / 6) * 1)
    expect(value5[1]).to.equal(((8 + 6 + 6) / 6) * 1)
  })

  it('should return value for Agents in Charge', () => {
    const value1 = getCardValue('I25', 1)
    const value5 = getCardValue('I25', 5)
    expect(value1[0]).to.equal((3 / 5) * 1.75)
    expect(value1[1]).to.equal((3 / 5) * 1.75)
    expect(value5[0]).to.equal((7 / 5) * 1.75)
    expect(value5[1]).to.equal((7 / 5) * 1.75)
  })

  it('should return value for Operators', () => {
    const value1 = getCardValue('I26', 1)
    const value5 = getCardValue('I26', 5)
    expect(value1[0]).to.equal((10 / 8) * 1)
    expect(value1[1]).to.equal((10 / 8) * 1)
    expect(value5[0]).to.equal((24 / 8) * 1)
    expect(value5[1]).to.equal((24 / 8) * 1)
  })
  ...
  it('should return value for Scrapped Planners', () => {
    ...
    expect(value1[0]).to.equal((4 / 4) * 1)
    expect(value1[1]).to.equal(((4 + 2) / 4) * 1)
    expect(value5[0]).to.equal((8 / 4) * 1)
    expect(value5[1]).to.equal(((8 + 6) / 4) * 1)
  })
  ...
  it('should return value for Booming Professors', () => {
    ...
    expect(value1[0]).to.equal((5 / 6) * 0.5)
    expect(value1[1]).to.equal(((5 + 3) / 6) * 0.5)
    expect(value5[0]).to.equal((10 / 6) * 0.5)
    expect(value5[1]).to.equal(((10 + 6) / 6) * 0.5)
  })
  ...
  it('should return value for Brood Sages', () => {
    ...
    expect(value1[0]).to.equal((2 / 2) * 0.5)
    expect(value1[1]).to.equal(((2 + 10 * 1) / 2) * 1)
    expect(value5[0]).to.equal((5 / 2) * 0.5)
    expect(value5[1]).to.equal(((5 + 10 * 1) / 2) * 1)
  })
  ...
  it('should return value for Copperskin Ranger', () => {
    ...
    expect(value1[0]).to.equal((1 / 2) * 0.5)
    expect(value1[1]).to.equal((1 / 2) * 0.5)
    expect(value5[0]).to.equal((3 / 2) * 0.5)
    expect(value5[1]).to.equal((3 / 2) * 0.5)
  })
  ...
  it('should return value for Crimson Sentry', () => {
    ...
    expect(value1[0]).to.equal((1 / 3) * 1.5)
    expect(value1[1]).to.equal(((1 + 4 * 1) / 3) * 1.5)
    expect(value5[0]).to.equal((1 / 3) * 1.5)
    expect(value5[1]).to.equal(((1 + 4 * 5) / 3) * 1.5)
  })

  it('should return value for Harpies of the Hunt', () => {
    const value1 = getCardValue('F6', 1)
    const value5 = getCardValue('F6', 5)
    expect(value1[0]).to.equal((4 / 3) * 0.5)
    expect(value1[1]).to.equal((4 / 3) * 0.5)
    expect(value5[0]).to.equal((8 / 3) * 0.5)
    expect(value5[1]).to.equal((8 / 3) * 0.5)
  })

  it('should return value for Heliotroopers', () => {
    const value1 = getCardValue('F7', 1)
    const value5 = getCardValue('F7', 5)
    expect(value1[0]).to.equal((3 / 3) * 1)
    expect(value1[1]).to.equal((3 / 3) * 1)
    expect(value5[0]).to.equal((7 / 3) * 1)
    expect(value5[1]).to.equal((7 / 3) * 1)
  })
  ...
  it('should return value for Wandering Wyrms', () => {
    ...
    expect(value1[0]).to.equal((3 / 3) * 0.5)
    expect(value1[1]).to.equal(((3 + 3) / 3) * 0.5)
    expect(value5[0]).to.equal((3 / 3) * 0.5)
    expect(value5[1]).to.equal(((3 + 7) / 3) * 0.5)
  })

  it('should return value for Azure Hatcher', () => {
    const value1 = getCardValue('F10', 1)
    const value5 = getCardValue('F10', 5)
    expect(value1[0]).to.equal((1 / 4) * 1.5)
    expect(value1[1]).to.equal(((1 + 2 * 1) / 4) * 1.5)
    expect(value5[0]).to.equal((1 / 4) * 1.5)
    expect(value5[1]).to.equal(((1 + 6 * 1) / 4) * 1.5)
  })
  ...
  it('should return value for Tode the Elevated', () => {
    ...
    expect(value1[0]).to.equal((3 / 4) * 1)
    expect(value1[1]).to.equal(((3 + 3) / 4) * 1)
    expect(value5[0]).to.equal((7 / 4) * 1)
    expect(value5[1]).to.equal(((7 + 7) / 4) * 1)
  })
  ...
  it('should return value for Witches of the Wild', () => {
    ...
    expect(value1[0]).to.equal((2 / 4) * 1)
    expect(value1[1]).to.equal(((2 + 1 * 4 * 2) / 4) * 1)
    expect(value5[0]).to.equal((5 / 4) * 1)
    expect(value5[1]).to.equal(((5 + 3 * 4 * 2) / 4) * 1)
  })
  ...
  it('should return value for Amberhides', () => {
    ...
    expect(value1[0]).to.equal((4 / 5) * 1)
    expect(value1[1]).to.equal(((4 + 4 * 2) / 5) * 1)
    expect(value5[0]).to.equal((8 / 5) * 1)
    expect(value5[1]).to.equal(((8 + 8 * 2) / 5) * 1)
  })

  it('should return value for Feral Shamans', () => {
    const value1 = getCardValue('F16', 1)
    const value5 = getCardValue('F16', 5)
    expect(value1[0]).to.equal((1 / 5) * 1)
    expect(value1[1]).to.equal(((1 + 3 * 2) / 5) * 1)
    expect(value5[0]).to.equal((3 / 5) * 1)
  ...
  it('should return value for Soulcrushers', () => {
    ...
    expect(value1[0]).to.equal((5 / 5) * 1)
    expect(value1[1]).to.equal(((5 * 2 - 1) / 5) * 1)
    expect(value5[0]).to.equal((10 / 5) * 1)
  ...
  it('should return value for Curse of Strings', () => {
    ...
    expect(value1[0]).to.equal((1 * 2) / 7)
    expect(value1[1]).to.equal((8 * 2) / 7)
    expect(value5[0]).to.equal((1 * 2) / 7)
    expect(value5[1]).to.equal((18 * 2) / 7)
  })

  it('should return value for High Priestess Klaxi', () => {
    const value1 = getCardValue('F23', 1)
    const value5 = getCardValue('F23', 5)
    expect(value1[0]).to.equal((5 / 8) * 0.5)
    expect(value1[1]).to.equal(((5 + 19 * 5 * 2) / 8) * 0.5)
    expect(value5[0]).to.equal((10 / 8) * 0.5)
    expect(value5[1]).to.equal(((10 + 19 * 10 * 2) / 8) * 0.5)
  })
  ...
  it('should return value for Clerics with Cords', () => {
    ...
    expect(value1[0]).to.equal((3 / 4) * 0.5)
    expect(value1[1]).to.equal(((3 + 2 * 2) / 4) * 0.5)
    expect(value5[0]).to.equal((7 / 4) * 0.5)
    expect(value5[1]).to.equal(((7 + 6 * 2) / 4) * 0.5)
  })
  ...
  it('should return value for Untamed Cultists', () => {
    ...
    expect(value1[0]).to.equal((10 / 7) * 0.5)
    expect(value1[1]).to.equal((10 / 7) * 0.5)
    expect(value5[0]).to.equal((24 / 7) * 0.5)
    expect(value5[1]).to.equal((24 / 7) * 0.5)
  })

  it('should return value for Faithless Prophets', () => {
    const value1 = getCardValue('F27', 1)
    const value5 = getCardValue('F27', 5)
    expect(value1[0]).to.equal(((1 - 4 * 2) / 3) * 1)
    expect(value1[1]).to.equal((5 / 3) * 1)
    expect(value5[0]).to.equal(((1 - 9 * 2) / 3) * 1)
    expect(value5[1]).to.equal((10 / 3) * 1)
  })
  ...
  it('should return value for Doppelbocks', () => {
    ...
    expect(value1[0]).to.equal((1 / 2) * 0.5)
    expect(value1[1]).to.equal(((1 + 1) / 2) * 1)
    expect(value5[0]).to.equal((3 / 2) * 0.5)
    expect(value5[1]).to.equal(((3 + 3) / 2) * 1)
  })

  it('should return value for Restless Goats', () => {
    const value1 = getCardValue('S2', 1)
    const value5 = getCardValue('S2', 5)
    expect(value1[0]).to.equal(((1 - 2) / 2) * 1.5)
    expect(value1[1]).to.equal(((1 - 2) / 2) * 1.5)
    expect(value5[0]).to.equal(((5 - 2) / 2) * 1.5)
    expect(value5[1]).to.equal(((5 - 2) / 2) * 1.5)
  })
  ...
  it('should return value for Dreadful Keepers', () => {
    ...
    expect(value1[1]).to.equal(((3 + 3) / 3) * 0.5)
    expect(value5[0]).to.equal((7 / 3) * 0.5)
    expect(value5[1]).to.equal(((7 + 7) / 3) * 0.5)
  })
  ...
  it('should return value for Faun Companions', () => {
    ...
    expect(value1[0]).to.equal((1 / 3) * 1)
    expect(value1[1]).to.equal(((1 + 3) / 3) * 1)
    expect(value5[0]).to.equal((3 / 3) * 1)
  ...
  it('should return value for Shady Ghoul', () => {
    ...
    expect(value1[0]).to.equal((1 / 3) * 1.5)
    expect(value1[1]).to.equal(((1 + 1) / 3) * 1.5)
    expect(value5[0]).to.equal((1 / 3) * 1.5)
    expect(value5[1]).to.equal(((1 + 5) / 3) * 1.5)
  })
  ...
  it('should return value for Swarmcallers', () => {
    ...
    expect(value1[0]).to.equal((2 / 4) * 1)
    expect(value1[1]).to.equal(((2 + 2 * 4) / 4) * 1)
    expect(value5[0]).to.equal((5 / 4) * 1)
    expect(value5[1]).to.equal(((5 + 4 * 4) / 4) * 1)
  })
  ...
  it('should return value for Draconic Roamers', () => {
    ...
    expect(value1[0]).to.equal((2 / 4) * 1.5)
    expect(value1[1]).to.equal(((2 + 1 * 2) / 4) * 1.5)
    expect(value5[0]).to.equal((4 / 4) * 1.5)
    expect(value5[1]).to.equal(((4 + 3 * 2) / 4) * 1.5)
  })
  ...
  it('should return value for Mischiefs', () => {
    ...
    expect(value1[0]).to.equal(((2 + 1) / 4) * 1)
    expect(value1[1]).to.equal(((2 + 1) / 4) * 1)
    expect(value5[0]).to.equal(((5 + 2) / 4) * 1)
    expect(value5[1]).to.equal(((5 + 2) / 4) * 1)
  })
  ...
  it('should return value for Pan Heralds', () => {
    ...
    expect(value1[0]).to.equal((3 / 4) * 0.5)
    expect(value1[1]).to.equal(((3 + 1 * 8) / 4) * 0.5)
    expect(value5[0]).to.equal((6 / 4) * 0.5)
    expect(value5[1]).to.equal(((6 + 3 * 8) / 4) * 0.5)
  })
  ...
  it('should return value for Dreadfauns', () => {
    ...
    expect(value1[0]).to.equal((3 / 5) * 0.5)
    expect(value1[1]).to.equal(((3 + 2 * 2) / 5) * 1)
    expect(value5[0]).to.equal((6 / 5) * 0.5)
    expect(value5[1]).to.equal(((6 + 2 * 4) / 5) * 1)
  })
  ...
  it('should return value for Pillars of Doom', () => {
    ...
    expect(value1[0]).to.equal(4 / 5)
    expect(value1[1]).to.equal((4 + 2) / 5)
    expect(value5[0]).to.equal(8 / 5)
    expect(value5[1]).to.equal((8 + 4) / 5)
  })
  ...
  it('should return value for Xuri, Lord of Life', () => {
    ...
    expect(value1[0]).to.equal((3 / 5) * 0.5)
    expect(value1[1]).to.equal(((3 + 3 * 3) / 5) * 2)
    expect(value5[0]).to.equal((7 / 5) * 0.5)
    expect(value5[1]).to.equal(((7 + 3 * 7) / 5) * 2)
  })
  ...
  it('should return value for Vindicators', () => {
    ...
    expect(value1[0]).to.equal((3 / 6) * 1.75)
    expect(value1[1]).to.equal(((3 + 1 * 3) / 6) * 1.75)
    expect(value5[0]).to.equal((6 / 6) * 1.75)
    expect(value5[1]).to.equal(((6 + 2 * 3) / 6) * 1.75)
  })
  ...
  it('should return value for Obliterators', () => {
    ...
    expect(value1[0]).to.equal((4 / 6) * 1.5)
    expect(value1[1]).to.equal((4 / 6) * 1.5)
    expect(value5[0]).to.equal((8 / 6) * 1.5)
    expect(value5[1]).to.equal((8 / 6) * 1.5)
  })
  ...
  it('should return value for Bucks of Wasteland', () => {
    ...
    expect(value1[0]).to.equal((6 / 6) * 0.5)
    expect(value1[1]).to.equal(((6 + 5 * 2) / 6) * 0.5)
    expect(value5[0]).to.equal((14 / 6) * 0.5)
    expect(value5[1]).to.equal(((14 + 13 * 2) / 6) * 0.5)
  })

  it('should return value for Icicle Burst', () => {
    const value1 = getCardValue('W1', 1)
    const value5 = getCardValue('W1', 5)
    expect(value1[0]).to.equal(1 / 1)
    expect(value1[1]).to.equal(8 / 1)
    expect(value5[0]).to.equal(1 / 1)
    expect(value5[1]).to.equal(18 / 1)
  })
  ...
  it('should return value for The Hearth', () => {
    ...
    expect(value1[0]).to.equal(3 / 3)
    expect(value1[1]).to.equal((3 + 2) / 3)
    expect(value5[0]).to.equal(6 / 3)
    expect(value5[1]).to.equal((6 + 4) / 3)
  })
  ...
  it('should return value for Wisp Cloud', () => {
    ...
    expect(value1[0]).to.equal((1 / 3) * 1)
    expect(value1[1]).to.equal(((1 + 4 * 8) / 3) * 1)
    expect(value5[0]).to.equal((5 / 3) * 1)
    expect(value5[1]).to.equal(((5 + 8 * 8) / 3) * 1)
  })

  it('should return value for Yowling Weavers', () => {
    const value1 = getCardValue('W5', 1)
    const value5 = getCardValue('W5', 5)
    expect(value1[0]).to.equal((4 / 3) * 1)
    expect(value1[1]).to.equal((4 / 3) * 1)
    expect(value5[0]).to.equal((8 / 3) * 1)
    expect(value5[1]).to.equal((8 / 3) * 1)
  })
  ...
  it('should return value for Moment’s Peace', () => {
    ...
    expect(value1[0]).to.equal(4 / 5)
    expect(value1[1]).to.equal(4 / 5)
    expect(value5[0]).to.equal(8 / 5)
    expect(value5[1]).to.equal(8 / 5)
  })
  ...
  it('should return value for Mystwives', () => {
    ...
    expect(value1[0]).to.equal((3 / 4) * 1)
    expect(value1[1]).to.equal(((3 + 4) / 4) * 1)
    expect(value5[0]).to.equal((3 / 4) * 1)
    expect(value5[1]).to.equal(((3 + 8) / 4) * 1)
  })
  ...
  it('should return value for Rimelings', () => {
    ...
    expect(value1[0]).to.equal((2 / 2) * 1)
    expect(value1[1]).to.equal((2 / 2) * 1)
    expect(value5[0]).to.equal((6 / 2) * 1)
    expect(value5[1]).to.equal((6 / 2) * 1)
  })
  ...
  it('should return value for Rockworkers', () => {
    ...
    expect(value1[0]).to.equal((4 / 5) * 0.5)
    expect(value1[1]).to.equal(((4 + 4) / 5) * 1)
    expect(value5[0]).to.equal((8 / 5) * 0.5)
    expect(value5[1]).to.equal(((8 + 8) / 5) * 1)
  })

  it('should return value for Blessed with Brawn', () => {
    const value1 = getCardValue('W14', 1)
    const value5 = getCardValue('W14', 5)
    expect(value1[0]).to.equal(8 / 6)
    expect(value1[1]).to.equal(8 / 6)
    expect(value5[0]).to.equal(18 / 6)
    expect(value5[1]).to.equal(18 / 6)
  })

  it('should return value for Broken Earth Drakes', () => {
    const value1 = getCardValue('W15', 1)
    const value5 = getCardValue('W15', 5)
    expect(value1[0]).to.equal(((3 - 3 * 18) / 7) * 1)
    expect(value1[1]).to.equal(((3 + 3 * 18) / 7) * 1)
    expect(value5[0]).to.equal(((3 - 7 * 18) / 7) * 1)
    expect(value5[1]).to.equal(((3 + 7 * 18) / 7) * 1)
  })
  ...
  it('should return value for Wolfcloaks', () => {
    ...
    expect(value1[0]).to.equal((1 / 6) * 1.5)
    expect(value1[1]).to.equal((6 / 6) * 1.5)
    expect(value5[0]).to.equal((1 / 6) * 1.5)
    expect(value5[1]).to.equal((12 / 6) * 1.5)
  })

  it('should return value for Fleshmenders', () => {
    const value1 = getCardValue('W18', 1)
    const value5 = getCardValue('W18', 5)
    expect(value1[0]).to.equal((4 / 7) * 1.5)
    expect(value1[1]).to.equal(((4 + 6) / 7) * 1.5)
    expect(value5[0]).to.equal((8 / 7) * 1.5)
    expect(value5[1]).to.equal(((8 + 12) / 7) * 1.5)
  })
  ...
  it('should return value for Chillbeards', () => {
    ...
    expect(value1[0]).to.equal((4 / 9) * 1.5)
    expect(value1[1]).to.equal(((4 + 4) / 9) * 1.5)
    expect(value5[0]).to.equal((8 / 9) * 1.5)
    expect(value5[1]).to.equal(((8 + 8) / 9) * 1.5)
  })

  it('should return value for Olf the Hammer', () => {
    const value1 = getCardValue('W23', 1)
    const value5 = getCardValue('W23', 5)
    expect(value1[0]).to.equal((6 / 9) * 1.5)
    expect(value1[1]).to.equal(((6 + 3) / 9) * 1.5)
    expect(value5[0]).to.equal((12 / 9) * 1.5)
    expect(value5[1]).to.equal(((12 + 6) / 9) * 1.5)
  })
  ...
  it('should return value for Sleetstompers', () => {
    ...
    expect(value1[0]).to.equal((6 / 8) * 1.5)
    expect(value1[1]).to.equal((6 / 8) * 1.5)
    expect(value5[0]).to.equal((12 / 8) * 1.5)
    expect(value5[1]).to.equal((12 / 8) * 1.5)
  })
  ...
  it('should return value for Earthfathers', () => {
    ...
    expect(value1[1]).to.equal(((5 + 3) / 7) * 1)
    expect(value5[0]).to.equal((11 / 7) * 1)
    expect(value5[1]).to.equal(((11 + 4) / 7) * 1)
  })
