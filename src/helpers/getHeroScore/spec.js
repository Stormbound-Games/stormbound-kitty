...
const CASES = [
  ...
  [[1000, 1000, 40, true], 1010],
  [[1000, 1000, 40, false], 995],
  [[2000, 2300, 40, true], 2010],
  [[2300, 2000, 40, false], 2295],
  [[2800, 2400, 10, true], 2801],
...
describe.only('The `getHeroScore` helper', () => {
  it('should pass Sheepyard-provided test cases', () => {
    CASES.forEach(([variables, expected]) => {
      ...
      expect(getHeroScore({ current, opponent, coefficient, won })).to.equal(
        expected
      )
    })
  })
