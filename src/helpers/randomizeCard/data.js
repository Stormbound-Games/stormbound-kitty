...
const FELINE = new Race('feline', 'neutral', 'T13', range(0, 3))
...
// prettier-ignore
const RACES = [KNIGHT, PIRATE, FELINE, DRAGON, RAVEN, TOAD, RODENT, CONSTRUCT, FROSTLING, DWARF, SATYR, UNDEAD]
...
FELINE.addEffects([
  ...
  new Effect('confuse {targetUnit} friendly {targetUnit2}', [3, 3, 3, 3, 3], -0.5),
