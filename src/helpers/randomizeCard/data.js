...
STRUCTURE_SHADOWFEN.addEffects([
  new Effect('deal {valueFast} damage to {targetStructure} enemy {targetStructure2}{enemyAnd}{deathEffect}{structureThen}', [], 1),
  ...
  new Effect('destroy {targetStructure} friendly {targetStructure2}2, then {deathEffect} and {deathEffect}{structureThen}', [], 1),
  new Effect('poison {targetStructure} enemy {targetStructure2}{structureThen}', [], 0.75),
  new Effect('convert {targetStructure} enemy {targetStructure2} {condition}{structureThen}', [], 2),
  new Effect('destroy {targetStructure} enemy {targetStructure2} {condition}{structureThen}', [], 1.5 ),
